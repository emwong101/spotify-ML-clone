...
function MoodInputs({ type, src }) {
  ...
  return (
    <div className="mood-input">
      ...
      <label className="mood-input__label" htmlFor={type}>
        <img src={src} alt={type} className="mood-input__picture" />
        <p className="mood-input__selection">{type}</p>
      </label>
    </div>
  );
}
